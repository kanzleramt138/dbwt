...
CREATE TABLE gericht (
    ...
    preisintern     double precision    NOT NULL,
    preisextern     double precision    NOT NULL,
    CONSTRAINT preis_extern
        CHECK (preisextern > 0),
    CONSTRAINT check_preise
...
SELECT "19" AS "COUNT gericht";
SELECT COUNT(*) FROM allergen;
SELECT "21" AS "COUNT allergen";
SELECT COUNT(*) FROM kategorie;
SELECT "7" AS "COUNT kategorie";
